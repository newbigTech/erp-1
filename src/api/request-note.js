...
export const url_get_list = 'get|virtual-order';
...
//获取货币类型
export const url_get_currency_type = "get|virtual-order/currency";
...
export const api_get_mission_type = function(data){
    return http(url_get_mission_type, data);
};