            ...
            <el-col v-if="showAdd" :span="12">
                ...
                <div class="fr mt-md mb-xs">
                    <request-button :disabled="!showButton"
                               req-key="saveMember" :min-time="300"
...
<script>
    ...
    import {api_post_account_users,api_account_users_batch} from '../../../api/account-information'
    export default{
        data(){
            return{
                memberSize:"large",
...
//            ------------------------------------  保存
            save_member(){
                if(this.id){
                    ...
                    this.$http(api_account_users_batch,params).then(res => {
