    ...
    <page-dialog v-model="dialog" size="small" :close-on-click-modal="false" :title="title">
         <el-form :model="form" label-width="200px" :rules="rules" ref="form">
             ...
             <el-form-item label="账号名称：" prop="account_name">
                 <el-col :span="14">
                    <el-input v-if="curPage === 'add'" :disabled="isDisabled" v-model="form.account_name"></el-input>
                    <span v-else>{{form.account_name}}</span>
                 </el-col>
             </el-form-item>
             <el-form-item label="抓取CD订单功能：">
                 <el-col :span="14">
                     <el-select v-if="curPage === 'add'" v-model="form.download_order" default-first-option filterable clearable>
                         <el-option
             ...
             <el-form-item label="同步发货状态到CD功能：">
                 <el-col :span="14">
                     <el-select v-if="curPage === 'add'" v-model="form.sync_delivery" default-first-option filterable clearable>
                         <el-option
                                 v-for="res in timeList"
                                 :label="res.label"
                                 :value="res.value"
             ...
             <el-form-item label="抓取Listing功能：">
                 <el-col :span="14">
                     <el-select v-if="curPage === 'add'" v-model="form.download_listing" default-first-option filterable clearable>
                         <el-option
                                 v-for="res in timeList"
                                 :label="res.label"
                                 :value="res.value"
