    ...
    <el-row class="p-paytm-table">
        <el-table v-resize="{height:41}"
            ...
            <el-table-column inline-template
                             label="密钥有效期"
                             sortable>
                <ui-tip :content="row.expiry_time | timeFilter" :width="98"></ui-tip>
            </el-table-column>
            ...
            <el-table-column label="操作" inline-template align="center" width="260">
                <div>
                    <permission
                        tag="span"
                        :route="apis.url_get_paytm_account"
                        class="operate"
                    ...
                    <permission
                        tag="span"
                        :route="apis.url_put_paytm_account"
                        class="operate"
                        @click="edit(row)">编辑
                    </permission>
                    <permission
                    ...
                    <permission
                        tag="span"
                        :route="apis.url_token_paytm_account"
                        class="operate"
                    ...
                    <permission
                        ...
                        :route="apis.url_token_paytm_account"
                        class="operate"
                        @click="add_merchandise(row)">{{row.is_authorization_cat | filterCommodity}}
                    </permission>
                </div>
            </el-table-column>
        </el-table>
        ...
        methods: {
            ...
            changStatus(row) {//-----------------------修改启用或禁用事件
                ...
                this.$confirm('您将' + statusTitle + '，确认此操作吗？', '提示', {
                    ...
                    this.$http(api_paytm_account_states, params).then(res => {
                        this.$message({
                            type: 'success',
