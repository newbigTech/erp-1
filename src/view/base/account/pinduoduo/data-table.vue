<template>
    <div class="c-table-data">
        <el-table
            ...
            <el-table-column label="账户名称" prop="name" sortable></el-table-column>
            ...
            <el-table-column label="拼多多状态" inline-template>
                <div :class="parseInt(row.platform_status)===0?'loseStatus':'sucStatus'">{{row.platform_status | filterEnabled}}</div>
            </el-table-column>
            ...
            <el-table-column label="密钥有效期" prop="time"></el-table-column>
...
<script>
    import {api_system_states,url_refresh_token,api_refresh_token} from '@/api/pdd';
    export default {
        permission:{
            url_refresh_token
        },
