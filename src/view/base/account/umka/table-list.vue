<template>
    <div class="c-table-data">
        <el-table
            ...
            <el-table-column label="简称" prop="code" ></el-table-column>
                ...
                <div v-if="row.is_invalid=='1'">
                    ...
                    <span>
                            <span class="succeed-download-listing"
                                  v-if="parseInt(row.sync_listing)>0"
                                  :title="`远程刊登数据${row.sync_listing}分钟抓取一次`"></span>
            ...
            <el-table-column label="Umka状态" inline-template>
            ...
            <el-table-column label="系统状态" inline-template>
                <div>
                    <el-switch v-model="row.is_invalid"
                               on-text="启用"
                               off-text="停用"
...
<script>
    import {api_umka_disable} from '@/api/Umka-account';
    export default {
        // permission:{
        //     url_refresh_token
        // },
        ...
        methods:{
            ...
            change_status(row){
                ...
                this.$confirm('您将' + statusTitle + '，确认此操作吗？', '提示', {
                    ...
                    this.$http(api_umka_disable, params).then(res => {
                        this.$message({
                            type: 'success',
                    ...
                    this.$message({
                     ...
                     cunrrentRow.is_invalid = !cunrrentRow.is_invalid
                });
            },
            update_token(row){
