<template>
    <page-dialog :title="title" v-model="show" size="small" @open="open" @cloce="cloce" :close-on-cilck-modal="false">
        <el-form :model="addEditData"
            ...
            <el-form-item label="抓取Walmart订单功能：">
                <el-col :span="14">
            ...
            <el-form-item label="同步发货状态到Walmart功能：">
                <el-col :span="14">
        ...
        <div slot="footer" class="dialog-footer">
            <request-button v-if="edit" req-key="addFormwalmart" :timeout="300"
