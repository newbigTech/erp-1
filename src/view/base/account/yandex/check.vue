    ...
    <page-dialog v-model="dialog" size="small" :close-on-click-modal="false" :title="title">
        <el-form :model="form" label-width="200px" :rules="rules" ref="form">
            ...
            <el-form-item label="抓取yandex订单功能：">
                <el-col :span="14">
                    <el-select  v-model="form.download_order" default-first-option filterable >
                        <el-option
            ...
            <el-form-item label="同步发货状态到yandex功能：">
                <el-col :span="14">
                    <el-select  v-model="form.sync_delivery" default-first-option filterable >
                        <el-option
                                v-for="res in timeList"
                                :label="res.label"
                                :value="res.value"
            ...
            <el-form-item label="抓取Listing功能：">
                <el-col :span="14">
                    <el-select  v-model="form.download_listing" default-first-option filterable >
                        <el-option
                                v-for="res in timeList"
                                :label="res.label"
                                :value="res.value"
...
<script>
    ...
    export default {
        ...
        updated(){
            console.log(this.form,'ggwwwwaaaaaa')
        },
        methods:{
            submit(){
                this.$emit('update');
