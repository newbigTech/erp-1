<template>
    <el-row class="p-bind-email">
        <el-button type="text" size="mini" @click.native="dialogFormVisible = true">绑定邮箱</el-button>
        <el-dialog title="账户xxx客户的邮箱" v-model="dialogFormVisible"   size="large" >
            <el-card class="box-card">
            <el-row :span="24"   style="text-align: center; background:#2B78E4;color:#ffffff">
            ...
            <el-row :span="24"   style="text-align: center; margin-top: 5px;" v-for="(item, index) in bindData">
                ...
                <el-row     style="text-align: center; margin-top: 40px;">
                    <el-col :span="2" >
                        <el-button type="primary" size="mini" @click="add_email">添加邮箱</el-button>
                    </el-col>
                    <el-col :span="3" >
                    ...
                    <el-col :span="3" >
                    <el-select v-model="bindData.encode">
                        <el-option
            ...
            <div slot="footer" class="dialog-footer">
                <el-button type="primary"   size="mini" @click.native="dialogFormVisible = false">保 存</el-button>
                <el-button type="primary" size="mini" @click.native="dialogFormVisible = false">取 消</el-button>
            </div>
