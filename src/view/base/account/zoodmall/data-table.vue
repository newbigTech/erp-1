<template>
    <el-row class="p-zoodmall-table">
        <el-table v-resize="{height:41}"
            ...
            <el-table-column label="ZoodMall状态" align="center" inline-template>
            ...
            <el-table-column label="操作" inline-template align="center" width="260">
                <div>
                    <permission
                            tag="span"
                            :route="apis.url_get_zoodmall_account"
                            class="operate"
                    ...
                    <permission
                            tag="span"
                            :route="apis.url_put_zoodmall_account"
                            class="operate"
                            @click="edit(row)">编辑
                    </permission>
                    <permission
                    ...
                    <permission
                            tag="span"
                            :route="apis.url_token_zoodmall_account"
                            class="operate"
...
<script>
    import {
        api_zoodmall_account_states,
        url_get_zoodmall_account,
        url_put_zoodmall_account,
        url_token_zoodmall_account} from '../../../../api/zoodmall-account';
    export default {
        permission: {
            url_get_zoodmall_account,
            url_put_zoodmall_account,
            url_token_zoodmall_account
        },
        data() {
            return {
                status: ["启用", "停用"],
        ...
        methods: {
            ...
            changStatus(row) {//-----------------------修改启用或禁用事件
                ...
                this.$confirm('您将' + statusTitle + '，确认此操作吗？', '提示', {
                    ...
                    this.$http(api_zoodmall_account_states, params).then(res => {
                        this.$message({
                            type: 'success',
