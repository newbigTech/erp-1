<template>
    <div>
        ...
        <input style="width:100px" class="inline el-input__inner" v-model="input" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" type="number" min="0" v-if="form.key=='strL'">
