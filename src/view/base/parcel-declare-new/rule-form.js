...
export default {
    components:{
        ...
        // rule1:require('../order-rule/rule1.vue').default,
        // rule2:require('../order-rule/rule2.vue').default,
        // rule3:require('../order-rule/rule3.vue').default,
        // rule4:require('../order-rule/rule4.vue').default,
        // rule5:require('../order-rule/rule5.vue').default,
        // rule7:require('../order-rule/rule7.vue').default,
        // rule8:require('../order-rule/rule8.vue').default,
    },
    props:{
        config:{},
        data:{},
    ...
    render(createElement){
        ...
        let row2dom = (data, type,row)=>{
            ...
            switch(type){
                case 1://1-复选
                    return createElement('rule1',{props:{form:row,value:data.value,operator:data.operator},on:{
                        input(val){
