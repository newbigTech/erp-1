<template>
    <page-dialog class="form-mdf-ali-issue" :title="defaultTitle"
        ...
        <el-row>
            ...
            <el-col :span="isShow?14:24" :style="`padding-left: 4px; padding-right: 4px;overflow-y: auto;max-height: ${maxHeight};`">
                <div>
                    <tabs>
                        <tab-head class="tab-heads"
                            ...
                            <div>
                                ...
                                <div class="mes-box blue-color mb-mini"
                                    ...
                                    <ui-tips :content="item.note" style="vertical-align: bottom;" :width="70"></ui-tips>
                                    <span class="fr">
            ...
            <el-col :span="10" v-if="isShow" :style="`padding-left: 4px; padding-right: 4px;overflow-y: auto;max-height: ${maxHeight};`">
                <div>
                    <paypal-dispute
                            ref="shopeeDispute"
                            :formData="form_data"
                            ...
                            @add-aftermarker="add_aftermarker"></paypal-dispute>
                </div>
            </el-col>
        </el-row>
        <span slot="footer">
...
//                this.$set(this.forms[this.mdfid], 'product_list', form);
        ...
        computed: {
            ...
            maxHeight(){
                ...
                return `${parseFloat(nContent.height) * 0.85}px`
            },
            defaultTitle() {
                if (this.title) {
                    return this.title;
        ...
        components: {
            ...
            paypalDispute: require('./paypal-dispute.vue').default,//---paypal纠纷
