<template>
    <page-dialog class="after-sale-add" title="售后处理"
        ...
        <el-row :gutter="8">
                    ...
                    <div class="mt-xs colors-box bold-font">
                        <el-checkbox-group class="inline ml-xs"
                            ...
                            <el-checkbox :label="item.label"
                                         :disabled="!showDetail || (index>0&&!isAccept)"></el-checkbox>
                        </el-checkbox-group>
                    </div>
                    <!--退款   start-->
                                ...
                                <el-form label-width="85px">
                                    <el-form-item label="申请退款金额：">
                                        <el-input class="inline width-xs" v-model="refund_amount" value="number"
                                                  :disabled="!parseFloat(max_refund_amount)"></el-input>
            ...
            <el-col :span="14">
                <div class="box">
                    <form-mdf-after v-show="showDetail"
                                    :mdfid="orderId"
                                    :forms="forms"
                                    @submit-note="submit_note"
                                    @delete-note="delete_note"></form-mdf-after>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            filterPayName(val){
                return this.isShopeeDispute?'纠纷退款/退货':val
            },
            warehouse_remote() {
...
//          保存/取消 新增原因
            ...
            submit() {
                ...
                if(this.isShopeeDispute){
                    params.source_type = 1;
                    params.source_id = `shopee-${this.disputeParams.returnsn}`
                }
...
//            删除原因
        ...
        components: {
            ...
            formMdfAfter: require('../../../customer-service/after-sale/form-mdf-after.vue').default,
