...
export default {
    components:{
        ...
        rule1:require('@/view/base/order-rule/rule1.vue').default,
        rule2:require('@/view/base/order-rule/rule2.vue').default,
        rule3:require('@/view/base/order-rule/rule3.vue').default,
        rule4:require('@/view/base/order-rule/rule4.vue').default,
        rule5:require('@/view/base/order-rule/rule5.vue').default,
        rule7:require('@/view/base/order-rule/rule7.vue').default,
        rule8:require('@/view/base/order-rule/rule8.vue').default,
    },
    props:{
        config:{},
        data:{},
    ...
    render(createElement){
        let row2dom = (data, type,row)=>{
            ...
            switch(type){
                case 1://1-复选
                    this.$set(data, 'condition', row.condition);
                    return createElement('rule1',{props:{election:childs.length && this.config.election, form:data,value:data.value,operator:data.operator},on:{
                        input(val){
                            data.value = val;
                            switch (data.type){
                                case 1:
