...
export const print = function (bool, flag) {
    let arr = [];
    let html = '';
    this.templateData = this.printData.temp_type === 'guide' ? this.templateGuide : this.templateLabel;
    ...
    if (bool) {
        ...
        // console.log('打印内容', prints, arr, this.print_html, this.print_content);
        ...
        if (flag) {
            // 打印时转化
            this.batchData.identification.unshift('P0');
