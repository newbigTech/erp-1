<template>
    <page class="p-abnormal">
        ...
        <label-item label="处理状态：">
            <!--@change="warehouse_change"-->
            <!--v-model="handletype.id"-->
            <el-select  class="width-sm" v-model="value" >
                <el-option
        ...
        <!--&lt;!&ndash;@select="change_status"&ndash;&gt;-->
...
<script>
    ...
    export default {
                ...
                tableData: [
                    {
                        ...
                        yorder: '01020305',
                        corder: '201811,10001',
                        ytime: '2018-11-10 08:00',
                        jtime:'2018-11-10 08:00',
                        btype: '未拆',
                        abnormaltype: '包裹丢失',
                        crpeople: 'virus',
                        warehouse: 'xxx',
        ...
        mounted() {
            this.search();
            this.xxx_id = this.handletype[0].value
        },
        methods: {
            init_warehouse() {
        ...
        components: {
            ...
            tableCom: require('@/view/entrepot/package/receive-abnormal/long-undemolished/table-com.vue').default,
