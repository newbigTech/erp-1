    ...
    <page-dialog title="提示"
        ...
        <div class="discontinue-content">
            <el-row class="t-center">
                ...
                <span>{{`您将停用${action.shortname}，确认此操作吗？`}}</span>
            </el-row>
            ...
            <el-row class="t-center mt-sm" v-if="action.type === 'shipping'">
    ...
    export default {
        ...
        methods: {
            ...
            sure() {
                ...
                this.action.type === 'shipping' ? this.shipping_sure() : this.group_sure();
            },
            shipping_sure() {
                if(this.stop_type === '') {
