...
<script>
    import {api_stock_in_import} from "@/api/stock-in";
    import {api_stock_out_import} from "@/api/stock-out";
    ...
    export default {
        ...
        methods: {
            ...
            submit(file, data) {
                ...
                let api = this.importInfo.code === 'stock_out_import_goods' ? api_stock_out_import : api_stock_in_import;
            ...
            download_file() {
                ...
                let code = {
                    code: this.importInfo.code
                };
                downloadFile({
                    url: url,
                    get: code,
                    fileName: this.importInfo.file_url,
                    suffix: '.xlsx',
                })
            }
        },
