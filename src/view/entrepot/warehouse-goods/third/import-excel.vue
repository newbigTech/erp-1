...
<script>
    import {api_third_import, api_no_api_in} from "@/api/overseas-stock";
    ...
    export default {
        ...
        methods: {
            ...
            submit(file, data) {
                ...
                let api = this.code === 'third_inventory_import' ? api_third_import : api_no_api_in;
