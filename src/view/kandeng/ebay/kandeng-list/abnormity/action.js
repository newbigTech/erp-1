...
import {url_update_listing,url_save_listing} from '../../../../../api/ebay-kandeng-public-module';
export const operateList = [
  {label:"编辑",value:"2",api:url_save_listing,action:function(row){
    let params={id:row.id,goods_id:row.goods_id,isAdd:false,isCopy:false,isCopyListing:false,curPage:'abnormity'};
