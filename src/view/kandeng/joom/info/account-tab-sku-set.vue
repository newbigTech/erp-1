            ...
            <table style="width: 100%" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        ></ui-autocomplete>
                        <span style="padding: 0;margin: 0;border: 1px solid #333;cursor: pointer"
                              @click="all_as_the_pic('color')">PIC</span>
                    </td>
                    ...
                    <!--包装重量-->
                    <td>
                        <el-input class="inline" v-model="shipping_weight"
                                  @blur="batch(shipping_weight,'shipping_weight')"></el-input>
                    </td>
                ...
                <tr v-for="(row, index) in accountInfo.variant" :key="index">
                    ...
                    <!--展图-->
                    <td>
                        <!--<img :src="baseUrl + row.thumb" alt="" width="20" height="20">-->
                    ...
                    <td>
                        ...
                        ></ui-autocomplete>
                        <span style="padding: 0;margin: 0;border: 1px solid #333;cursor: pointer" @click="as_the_pic(row)">PIC</span>
                    </td>
                    ...
                    <td>
                        <el-input v-model="row.shipping_weight"></el-input>
                    </td>
...
<script>
    ...
    export default{
        ...
        methods: {
            ...
            // 批量处理颜色
            all_as_the_pic(field){
                this.color = 'As the picture';
                this.batch(this.color, field);
            },
            // 传出批量处理
            batch(value, field){
                if (value === '') {
