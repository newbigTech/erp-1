<template>
    <div class="c-data-table">
        <div class="ml-sm mb-xs">
            <el-button type="primary" size="mini" :disabled="!is_batch" @click.native="sell_bulk">批量改可售量</el-button>
        </div>
        <ui-table
            v-loading="loading"
        ...
        <amount-available v-model="amountAvailable" :selected-ids="selectedIds"></amount-available>
...
<script>
    ...
    export default{
        ...
        components: {
            ...
            amountAvailable:require('./amount-available.vue').default,
