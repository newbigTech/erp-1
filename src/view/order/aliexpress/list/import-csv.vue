<template>
    <page-dialog class="p-import-txt" title="资金明细导入" v-model="visible" @open="open" size="large" :close-on-click-modal="false">
...
<script>
    import {api_import_settle} from'../../../../api/aliexpress-order';
    export default {
        data() {
            return {
                visible: false,
