        ...
        <page-dialog :title="`查看订单：${checkList.order_id} 信息`" v-model="orderDialog" :size="dialogSize" :close-on-click-modal="false">
            ...
            <tabs>
                <tab-head :navs="[{label:'订单基本信息',action:''},{label:'产品信息',action:'product'},{label:'收货人信息',action:'buyinfo'}]">
                    <el-row>
                        ...
                        <el-col :span="12">
                            <div class="row-content">
                                <span class="label">订单生成时间</span>: <span class="detail">{{checkList.order_created|dateFilter}}</span>
                            </div>
                        </el-col>
                    </el-row>
                    <el-row>
                    ...
                    <el-row>
                        ...
                        <el-col :span="12">
                            <div class="row-content">
                                <span class="label">最近更新时间</span>: <span class="detail">{{checkList.order_updated|dateFilter}}</span>
                            </div>
                        </el-col>
                    </el-row>
                ...
                <tab-item id="product" label="产品信息">
                    <el-table :data="checkList.sku_list" border>
                        ...
                        <el-table-column label="出售价" align="center" inline-template  width="120" show-overflow-tooltip>
                            <div>
                                {{row.purchase_price}}({{checkList.currency}})
                            </div>
                        </el-table-column>
                    </el-table>
                </tab-item>
            <!--  收货人信息  -->
                <tab-item id="buyinfo" label="收货人信息">
                    ...
                    <div class="row-content">
                        <span class="label">州</span>:<span class="detail">{{checkList.address_county}}</span>
                    </div>
                    <div class="row-content">
