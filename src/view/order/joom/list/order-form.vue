        ...
        <page-dialog :title="`查看订单：${this.checkList.order_id} 信息`" v-model="orderDialog" :size="dialogSize" :close-on-click-modal="false">
            ...
            <tabs>
                <tab-head :navs="[{label:'订单基本信息',action:''},{label:'产品信息',action:'product'},{label:'收货人信息',action:'buyinfo'},{label:'售后',action:'service'}]">
                    ...
                    <el-row>
                        ...
                        <el-col :span="12">
                            <div class="row-content">
                                <span class="label">付款时间</span>: <span class="detail">{{checkList.create_time|dataFilter}}</span>
                            </div>
                        </el-col>
                    </el-row>
                    <el-row>
                        <el-col :span="12">
                            <div class="row-content">
                                <span class="label">出售价</span>: <span class="detail">{{checkList.order_total}}</span>
                            </div>
                        </el-col>
                        <el-col :span="12">
                            <div class="row-content">
                    ...
                    <el-row>
                        <el-col :span="12">
                            <div class="row-content">
                                <span class="label">支付总额</span>: <span class="detail">{{checkList.cost}}</span>
                            </div>
                        </el-col>
                        <el-col :span="12">
                            <div class="row-content">
                    ...
                    <el-row>
                        <el-col :span="12">
                            <div class="row-content">
                                <span class="label">发货时间</span>: <span class="detail">{{checkList.shipping_time|dataFilter}}</span>
                            </div>
                        </el-col>
                        <el-col :span="12">
                            <div class="row-content">
            ...
            <!--  收货人信息  -->
                <tab-item id="buyinfo" label="收货人信息">
                    <div class="row-content">
                        <span class="label">买家ID</span>:<span class="detail">{{checkList.order_id}}</span>
                    </div>
                    <div class="row-content">
                    ...
                    <div class="row-content">
                        <span class="label">州</span>:<span class="detail">{{checkList.city}}</span>
                    </div>
                    <div class="row-content">
                        <span class="label">城市</span>:<span class="detail">{{checkList.state}}</span>
                    </div>
                    <div class="row-content">
                        <span class="label">街道地址1</span>:<span class="detail">{{checkList.street_address1}}</span>
                    </div>
                    <div class="row-content">
            ...
            <!--  售后 -->
                <tab-item id="service" label="售后">
                    ...
                    <div class="row-content">
                        <span class="label">退款时间</span>:<span class="detail">{{checkList.refunded_time|dataFilter}}</span>
                    </div>
                    <div class="row-content">
                        <span class="label">退款原因</span>:<span class="detail">{{checkList.refubded_reason}}</span>
                    </div>
                    <div class="row-content">
