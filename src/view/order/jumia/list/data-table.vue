            ...
            <template v-for="(data, index) in dataTable">
                <tr class="line" :class="[data.show ? 'active' : '',data.clickData?'active-color':'']"
                    ...
                    <td>
                        <permission
                            tag="span"
                            :route="apis.url_api_order_jumia_check"
                            class="operate"
...
<script>
    ...
    import {api_order_jumia_check, api_jumia_orders_export, url_jumia_orders_export} from '../../../../api/order_jumia';
    import {url_api_order_jumia_check} from '../../../../api/order_jumia';
    import uiTable from "../../../../components/ui-table.vue"

    export default {
        permission: {
            url_api_order_jumia_check,
            url_jumia_orders_export
        },
        data() {
            return {
                orders: false,
        ...
        methods: {
            ...
            lookOver(row) {//----------------------查看
                this.orders = true;
                this.checkList = {};
                this.$http(api_order_jumia_check, row.id).then(res => {
                    this.checkList = res;
