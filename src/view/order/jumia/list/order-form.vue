<template>
    <el-row class="wish-order-form">
        <page-dialog :title="`查看订单：${checkList.order_id} 信息`" v-model="orderDialog" :size="dialogSize" :close-on-click-modal="false">
            <!--    cardControl     -->
            <tabs>
                <tab-head :navs="[{label:'订单基本信息',action:''},{label:'产品信息',action:'product'},{label:'收货人信息',action:'buyinfo'},{label:'售后',action:'service'}]">
                    ...
                    <el-row>
                        <el-col :span="12">
                            <div class="row-content">
                                <span class="label">交易ID</span>: <span class="detail">{{checkList.order_number}}</span>
                            </div>
                        </el-col>
                        <el-col :span="12">
                            <div class="row-content">
                                <span class="label">付款时间</span>: <span class="detail">{{checkList.order_created|dateFilter}}</span>
                            </div>
                        </el-col>
                    </el-row>
                    <el-row>
                    ...
                    <el-row>
                        <el-col :span="12">
                            <div class="row-content">
                                <span class="label">支付总额</span>: <span class="detail">{{checkList.price}}</span>
                            </div>
                        </el-col>
                        <el-col :span="12">
                            <div class="row-content">
                                <span class="label">税收金额</span>: <span class="detail">{{checkList.tax}}</span>
                            </div>
                        </el-col>
                    </el-row>
                    <el-row>
                    ...
                    <el-row>
                        <el-col :span="12">
                            <div class="row-content">
                                <span class="label">发货时间</span>: <span class="detail">{{checkList.shipped_date|dateFilter}}</span>
                            </div>
                        </el-col>
                        <el-col :span="12">
                            <div class="row-content">
            ...
            <!--  产品信息  -->
                <tab-item id="product" label="产品信息">
                    <el-table :data="checkList.sku_list" border>
                        ...
                        <el-table-column prop="qty" label="数量" align="center"  width="60"s show-overflow-tooltip></el-table-column>
                        <el-table-column label="出售价" align="center" inline-template  width="120" show-overflow-tooltip>
                            <div>
                                {{row.item_price}}({{checkList.currency}})
                            </div>
                        </el-table-column>
                    </el-table>
                </tab-item>
            <!--  收货人信息  -->
                <tab-item id="buyinfo" label="收货人信息">
                    <div class="row-content">
                        <span class="label">收货人</span>:<span class="detail">{{checkList.address_name}}</span>
                    </div>
                    <div class="row-content">
                ...
                <tab-item id="service" label="售后">
                    ...
                    <div class="row-content">
                        <span class="label">退款方</span>:<span class="detail">{{checkList.refunded_by}}</span>
                    </div>
                    <div class="row-content">
                        <span class="label">退款时间</span>:<span class="detail">{{checkList.refunded_time|dateFilter}}</span>
                    </div>
                    <div class="row-content">
                        <span class="label">退款原因</span>:<span class="detail">{{checkList.refunded_reason}}</span>
                    </div>
                    <div class="row-content">
                        <span class="label">退款备注</span>:<span class="detail">{{checkList.returnded_note}}</span>
                    </div>
                </tab-item>
            </tabs>
            <span slot="footer">
