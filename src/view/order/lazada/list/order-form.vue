        ...
        <page-dialog :title="`查看订单：${this.checkList.order_id} 信息`" v-model="orderDialog" :size="dialogSize" :close-on-click-modal="false">
            ...
            <tabs>
                <tab-head :navs="[{label:'订单基本信息',action:''},{label:'产品信息',action:'product'},{label:'收货人信息',action:'buyinfo'},{label:'售后',action:'service'}]">
                    ...
                    <el-row>
                        ...
                        <el-col :span="12">
                            <div class="row-content">
                                <span class="label">付款时间</span>: <span class="detail">{{checkList.created_at|dataFilter}}</span>
                            </div>
                        </el-col>
                    </el-row>
                    <el-row>
                        <el-col :span="12">
                            <div class="row-content">
                                <span class="label">出售价</span>: <span class="detail">{{checkList.item_price}}</span>
                            </div>
                        </el-col>
                        <el-col :span="12">
                            <div class="row-content">
                    ...
                    <el-row>
                        <el-col :span="12">
                            <div class="row-content">
                                <span class="label">支付总额</span>: <span class="detail">{{checkList.total_price}}</span>
                            </div>
                        </el-col>
                        <el-col :span="12">
                            <div class="row-content">
                    ...
                    <el-row>
                        <el-col :span="12">
                            <div class="row-content">
                                <span class="label">追踪号</span>: <span class="detail">{{checkList.tracking_code}}</span>
                            </div>
                        </el-col>
                        <el-col :span="12">
                            <div class="row-content">
                    ...
                    <el-row>
                        <el-col :span="12">
                            <div class="row-content">
                                <span class="label">发货时间</span>: <span class="detail">{{checkList.promised_shipping_time|dataFilter}}</span>
                            </div>
                        </el-col>
                        <el-col :span="12">
                            <div class="row-content">
                ...
                <tab-item id="product" label="产品信息">
                    <el-table :data="checkList.sku_list" border>
                        <el-table-column label="ItemId" align="center" show-overflow-tooltip  inline-template width="200">
                            <div>
                                <a class="link" :href="row.product_link" target="_blank">{{row.order_item_id}}</a>
                            </div>
                        </el-table-column>
                        ...
                        <el-table-column label="产品图片"  align="center" width="100" inline-template>
                            <div>
                                <el-popover
                                        ...
                                        placement="right"
                                        trigger="hover">
                                    <img v-lazy="sku_image(row.product_main_image)" width="200px" height="200px">
                                </el-popover>
                                <img v-popover:popover  class="wish-img" v-lazy="row.product_main_image" width="60px" height="60px">
                            </div>
                        </el-table-column>
                        ...
                        <el-table-column prop="qty" label="数量" align="center"  width="60" show-overflow-tooltip></el-table-column>
                        <el-table-column label="出售价" align="center" inline-template  width="100" show-overflow-tooltip>
                            <div>
                                {{row.item_price}}（{{row.currency}}）
                            </div>
                        </el-table-column>
                    </el-table>
                </tab-item>
            <!--  收货人信息  -->
                <tab-item id="buyinfo" label="收货人信息">
                    ...
                    <div class="row-content">
                        <span class="label">买家ID</span>:<span class="detail">{{checkList.lazada_id}}</span>
                    </div>
                    <div class="row-content">
                        <span class="label">收货人</span>:<span class="detail">{{checkList.address_shipping_name}}</span>
                    </div>
                    <div class="row-content">
                        <span class="label">电话</span>:<span class="detail">{{checkList.phone}}</span>
                    </div>
                    <div class="row-content">
                        <span class="label">国家</span>:<span class="detail">{{checkList.address_shipping_contry  }}</span>
                    </div>
                    <div class="row-content">
                        <span class="label">州</span>:<span class="detail">{{checkList.country}}</span>
                    </div>
                    <div class="row-content">
                        <span class="label">城市</span>:<span class="detail">{{checkList.address_shipping_city}}</span>
                    </div>
                    <div class="row-content">
                        <span class="label">地址1</span>:<span class="detail">{{checkList.address_shipping_address1}}</span>
                    </div>
                    <div class="row-content">
                        <span class="label">地址2</span>:<span class="detail">{{checkList.address_shipping_address2}}</span>
                    </div>
                    <div class="row-content">
                        <span class="label">邮编</span>:<span class="detail">{{checkList.address_shipping_post_code}}</span>
                    </div>
                </tab-item>
            <!--  售后 -->
                <tab-item id="service" label="售后">
                    <div class="row-content">
                        <span class="label">退款商家</span>:<span class="detail">{{checkList.shop_id}}</span>
                    </div>
                    <div class="row-content">
                        <span class="label">退款原因</span>:<span class="detail">{{checkList.reason}}</span>
                    </div>
                </tab-item>
            </tabs>
...
<script>
    ...
    export default{
        ...
        components: {
            ...
            tabItem,
            tabHead,
            uiTip:require('../../../../components/ui-tip'),
        }
    }
</script>
