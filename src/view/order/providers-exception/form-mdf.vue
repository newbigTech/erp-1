    ...
    <page-dialog class="form-mdf" :title="defaultTitle"
        ...
        <el-row>
                ...
                <tabs>
                    ...
                    <tab-item id="buyinfo" label="收件人信息">
                        <form-item-buyinfo :id="mdfid"
                                           :form="buyinfo"
                                           @submit="buyinfo_edit"
                                           :show-btn="!is_abolish"></form-item-buyinfo>
                    </tab-item>
                    ...
                    <tab-item id="logistics" label="仓储物流">
                        <form-item-logistics :id="mdfid" :form="logistics"
                                             ...
                                             :deadline="deadline"
                                             :is-hold="isHold" :btn-show="btnShow"
            ...
            <el-col :span="10" v-if="isShow" style="padding-left: 4px; padding-right: 4px;">
                <div>
                    <ebay-reques ref="ebayDispute" :formData="form_data" :dispute-data="disputeData"
                             :mark-id="markId"></ebay-reques>
                </div>
            </el-col>
        </el-row>
        <span slot="footer">
...
//            ...mapActions({
//                get_form:'./form-mdf-data/get_form',
//            }),
...
//                this.$set(this.forms[this.mdfid], 'product_list', form);
        ...
        computed: {
            ...
            // // 是否作废invalid.status&&invalid.status===4294967295
            // is_abolish(){
            //     return this.invalid.status&&this.invalid.status===4294967295
            // },
            logs: {
                get() {
                    let def = [];
                ...
                get() {
                    ...
                    if (this.mdfid > 0) {
                        if (this.forms[this.mdfid]) {
                            ...
                            console.log(this.forms[this.mdfid].product_list,'this.forms[this.mdfid].product_list');
        ...
        components: {
            ...
            formItemAftermarket: require('../local/form-item-aftermarket.vue').default,
            ...
            extensionTime: require('../local/extension-time.vue').default,
            selectRemote,
            pageDialog,
            cardControl,
            cardHidden,
            ...
            ebayReques: require('../../customer-service/dispute/ebay/ebay-dispute.vue').default,//------------链接到eBay纠纷
