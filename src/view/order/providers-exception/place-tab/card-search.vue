<template>
    <div class="c-card-search">
        <search-card :params="form" :clears="clears" ref="search" @search="search">
            <div class="mb-mini">
                <label-item label="">
            ...
            <label-item label="物流错误信息：">
                <el-input @keyup.native.enter="search" v-model="form.providers_error_info" placeholder="可模糊搜索"></el-input>
            </label-item>
            <div class="inline" slot="clear">
                ...
                <el-button class="inline"
                           ...
                           size="mini"
                           type="primary"
                           @click.native="error_info_search">错误信息解决方案
                </el-button>
            </div>
        </search-card>
    </div>
...
import {chinese} from "../../../../define/validator_reg";
    export default {
        ...
        computed:{
            ...
            hasParams() {
                return !!Object.values(this.form).find(val => !!val);
            },
            shippingPlaceholder(){
        ...
        methods:{
            ...
            clearParams(){
                this.$refs.search.clearParams();
            },
            error_info_search(){
                this.$emit('error-info-search');
            }
        },
        props:{
            form:{
