<template>
    <el-row class="wish-order-form">
        <page-dialog :title="`查看订单：${this.checkList.delivery_number} 信息`" v-model="orderDialog" :size="dialogSize" :close-on-click-modal="false">
            <!--    cardControl     -->
            <tabs>
                <tab-head :navs="[{label:'订单基本信息',action:''},{label:'产品信息',action:'product'},{label:'收货人信息',action:'buyinfo'}]">
                    <el-row>
                        <el-col :span="12">
                            <div class="row-content">
                                <span class="label">订单号</span>: <span class="detail">{{checkList.delivery_number}}</span>
                            </div>
                        </el-col>
                        <el-col :span="12">
                            <div class="row-content">
                                <span class="label">订单生成时间</span>: <span class="detail">{{checkList.order_time|dateFilter}}</span>
                            </div>
                        </el-col>
                    </el-row>
                    <el-row>
                    ...
                    <el-row>
                        ...
                        <el-col :span="12">
                            <div class="row-content">
                                <span class="label">付款时间</span>: <span class="detail">{{checkList.order_time | dateFilter}}</span>
                            </div>
                        </el-col>
                    </el-row>
                    <el-row>
                        <el-col :span="12">
                            <div class="row-content">
                                <span class="label">出售价</span>: <span class="detail">{{checkList.total_amount}}</span>
                            </div>
                        </el-col>
                        <el-col :span="12">
                            <div class="row-content">
                ...
                <tab-item id="product" label="产品信息">
                    <el-table :data="checkList.sku_list" border>
                        ...
                        <el-table-column label="产品图片"  align="center" width="100" inline-template>
                            <div>
                                <el-popover
                                    ...
                                    placement="right"
                                    trigger="hover">
                                    <img v-lazy="sku_image(row.image_url)" width="200px" height="200px">
                                </el-popover>
                                <img v-popover:popover  class="wish-img" v-lazy="row.image_url" width="60px" height="60px">
                            </div>
                        </el-table-column>
                        ...
                        <el-table-column label="出售价" align="center" inline-template  width="120" show-overflow-tooltip>
                            <div>
                                {{checkList.price}}({{checkList.currency}})
                            </div>
                        </el-table-column>
                    </el-table>
                </tab-item>
                ...
                <tab-item id="buyinfo" label="收货人信息">
                    ...
                    <div class="row-content">
                        <span class="label">街道地址1</span>:<span class="detail">{{checkList.address}}</span>
                    </div>
                    <div class="row-content">
                        <span class="label">街道地址2</span>:<span class="detail"></span>
                    </div>
                    <div class="row-content">
