...
<script>
    ...
    import {api_order_walmart_getAccount} from '../../../../api/order_walmart'
    export default{
        data(){
            return {
              isBatch:false,
              snTypeList:[
                  ...
                  {id:2,label:"买家ID",value:"customer_id"},
        ...
        methods:{
            getAccount(){
                this.$http(api_order_walmart_getAccount, {channel_id: 11}).then(res=>{
