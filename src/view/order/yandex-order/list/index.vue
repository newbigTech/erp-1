...
<script>
    ...
    import {api_order_yandex_list,api_order_yandex_status} from'../../.././../api/order-yandex';
    export default{
        page:{
            devinfo:{
                frontEnd:'熊辉',
        ...
        methods:{
            get_status(){
                ...
                data.status = -1;
                this.$http(api_order_yandex_status,data).then(res=>{
                    res.forEach(btn=>{
            ...
            init(){
                this.loading=true;
                this.dataTable=[];
                this.$http(api_order_yandex_list,this.get_params()).then(res => {
            ...
            sort_click(val){
                switch (val.label){
                    ...
                    case "付款日期":
                        ...
                        break;
                    case "平台发货状态":
                        this.searchData.sort_type="shipped_time";
                        break;
                    case "下单时间":
                        this.searchData.sort_type="time_created";
                        break;
