            ...
            <tabs>
                <tab-head :navs="[{label:'订单基本信息',action:''},{label:'产品信息',action:'product'},{label:'收货人信息',action:'buyinfo'}]">
                    ...
                    <el-row>
                        ...
                        <el-col :span="12">
                            <div class="row-content">
                                <span class="label">付款时间</span>: <span class="detail">{{checkList.time_created | dateFilter}}</span>
                            </div>
                        </el-col>
                    </el-row>
                    <el-row>
                        ...
                        <el-col :span="12">
                            <div class="row-content">
                                <span class="label">运费</span>: <span class="detail">{{checkList.delivery_total}}</span>
                            </div>
                        </el-col>
                    </el-row>
                    <el-row>
                    ...
                    <el-row>
                        <el-col :span="12">
                            <div class="row-content">
                                <span class="label">发货时间</span>: <span class="detail">{{checkList.shipped_time|dateFilter}}</span>
                            </div>
                        </el-col>
                        <el-col :span="12">
                            <div class="row-content">
                ...
                <tab-item id="product" label="产品信息">
                    <el-table :data="checkList.sku_list" border>
                        ...
                        <el-table-column prop="count" label="数量" align="center"  width="60"s show-overflow-tooltip></el-table-column>
                        <el-table-column label="出售价" align="center" inline-template  width="120" show-overflow-tooltip>
                            <div>
                                {{row.price}}({{checkList.currency}})
                            </div>
                        </el-table-column>
                    </el-table>
                </tab-item>
                ...
                <tab-item id="buyinfo" label="收货人信息">
                    ...
                    <div class="row-content">
                        <span class="label">收货人</span>:<span class="detail">{{checkList.recipient}}</span>
                    </div>
                    <div class="row-content">
                    ...
                    <div class="row-content">
                        <span class="label">街道地址1</span>:<span class="detail">{{checkList.street}}</span>
                    </div>
                    <div class="row-content">
                        <span class="label">街道地址2</span>:<span class="detail">{{checkList.house}}</span>
                    </div>
                    <div class="row-content">
