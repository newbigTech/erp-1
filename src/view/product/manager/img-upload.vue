    ...
    <div>
        <div class="p-images-box">
            <drag-drop v-model="images" tag="ul" v-if="thumbnailMode" class="image-thums im">
                ...
                <li class="image add-button" :style="imageStyle" @click="$refs.input.click();" v-if="!edit">
                    <i class="el-icon-plus"></i>
                    <span class="addImg"> 添加图片</span>
                </li>
            </drag-drop>
        </div>
        <input type="file" ref="inputTwo" hidden @change="mdf_change" :multiple="false">
                ...
                fileArr.forEach((file,index)=>{
                    ...
                    reader.onload =(e)=> {
                        ...
                        let parm = {
                            ...
                            name:file.name,
                            size:file.size,
                            sku_id:this.item && this.item.sku_id || '',
//                            attribute_id: this.item.attribute_id,
                            value_id: this.item && this.item.value_id || '',
                            image: imgs,
                            show:false,
                        };
