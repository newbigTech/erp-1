        ...
        >
            ...
            <template v-for="(order,index) in tableData">
                <tr :key="`${index}`">
                    ...
                    <!--发货日期-->
                    <td width="170">
                        <ui-tip :content="order.shipping_time | timeFilter" :width="79"></ui-tip>
                    </td>
                    <!--仓库类型-->
                    <td width="100">
                    ...
                    <!--邮寄方式-->
                    <td width="300">
                        <ui-tip :content="order.shipping_name" :width="60"></ui-tip>
                    </td>
                    <!--包裹号-->
                    <td width="300">
                    ...
                    <!--物流商单号-->
                    <td width="150">
                        <ui-tip :content="order.process_code" :width="79"></ui-tip>
                    </td>
                    <!--{label:'总售价原币',size:100},-->
                    <td width="100">
                    ...
                    <!--总售价-->
                    <td width="90">
                        <ui-tip :content="order.order_amount_CNY | toFixed4" :width="79"></ui-tip>
                    </td>
                    <!--渠道成交费-->
                    <td width="100">
                        <ui-tip :content="order.channel_cost_CNY | toFixed4" :width="79"></ui-tip>
                    </td>
                    <!--商品成本-->
                    <td width="100">
                        <ui-tip :content="order.goods_cost | toFixed4" :width="79"></ui-tip>
                    </td>
                    <!--物流费用-->
                    <td width="100">
                        <ui-tip :content="order.shipping_fee | toFixed4" :width="79"></ui-tip>
                    </td>
                    <!--包装费用-->
                    <td width="100">
                        <ui-tip :content="order.package_fee | toFixed4" :width="79"></ui-tip>
                    </td>
                    <!--利润-->
                    <td width="80">
                    ...
                    <!--货品总数-->
                    <td width="100">
                        <ui-tip :content="order.sku_count　|　toFixed4" :width="79"></ui-tip>
                    </td>
                </tr>
...
<script>
    import {api_report_aliexpress,api_get_orders_skus} from  '../../../../api/report-channel'
    export default {
        data(){
            return {
                tableData:[],
        ...
        methods: {
            init(){
                ...
                this.$http(api_report_aliexpress, data).then(res=>{
                    this.loading = false;
