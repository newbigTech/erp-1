<template>
    <div class="p-financial-ebay">
        <indent-table v-loading="loading"
                    ...
                    {label:'Paypal费用',size:100},
                    {label:'货币转换费用',size:100},
                    {label:'商品成本',size:100},
                    {label:'物流费用',size:100},
                    {label:'包装费用',size:100},
        ...
        >
            ...
            <template v-for="(order,index) in tableData">
                <tr>
                    ...
                    <!--邮寄方式-->
                    <td width="300">
                        <ui-tip :content="order.shipping_name" :width="60" :key="index" class="shipping_name"></ui-tip>
                    </td>
                    <!--包裹号-->
                    <td width="300">
                    ...
                    <!--Paypal费用-->
                    <td width="100">
                        <ui-tip :content="order.mc_fee_CNY | toFixed2" :width="89"></ui-tip>
                    </td>
                    <!--货币转换费用-->
                    <td width="100">
...
<script>
    import {api_report_eBay,api_get_orders_skus} from  '../../../../api/report-channel'
    export default {
        data(){
            return {
                tableData:[],
        ...
        methods: {
            init(){
                ...
                this.$http(api_report_eBay, data).then(res=>{
                    this.loading = false;
