        ...
        >
            ...
            <template v-for="(order,index) in tableData">
                <tr>
                    ...
                    <!--{label:'美元汇率',size:100}-->
                    <td width="100">
                        <ui-tip :content="order.rate_USD" :width="89"></ui-tip>
                    </td>
                    <!--售价奈拉-->
                    <td width="100">
                        <ui-tip :content="order.selling_price | toFixed2" :width="89"></ui-tip>
                    </td>
                    <!--奈拉汇率-->
                    <td width="100">
                        <ui-tip :content="order.rate | toFixed2" :width="89"></ui-tip>
                    </td>
                    <!--总售价-->
                    <td width="100">
...
<script>
    import {api_get_channel, api_account_list, api_get_warehouse, api_report_jumia, api_export_report, api_get_orders_skus} from  '../../../../api/report-channel'
    export default {
        data(){
            return {
                tableData:[],
        ...
        methods: {
            init(){
                ...
                this.$http(api_report_jumia, data).then(res=>{
                    this.loading = false;
