<template>
    <div>
        <indent-table v-loading="loading"
                      ...
                      :heads="[
                    //注意：更改此处size的时候需要更改下面对应的size并且还要去indent-table的width里改总宽度
                    {label:'订单号',size:301},
        ...
        >
            ...
            <template v-for="(order,index) in tableData">
                <tr>
                    ...
                    <!--发货日期-->
                    <td width="170">
                        <ui-tip :content="order.shipping_time" :width="89"></ui-tip>
                    </td>
                    <!--仓库类型-->
                    <td width="100">
...
<script>
    import {api_report_yandex,api_get_orders_skus} from  '@/api/report-channel'
    export default {
        data(){
            return {
                tableData:[],
        ...
        methods: {
            init(){
                ...
                this.$http(api_report_yandex, data).then(res=>{
                    this.loading = false;
