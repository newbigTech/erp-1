<template>
    <page class="p-index">
        <search-time :search-data="searchData" @search="search"
                     @getStatus="getStatus"
                     :account-list="accountList"></search-time>
...
<script>
    import {api_publised_on,api_publised_on_export,api_on_spu} from '../../../../api/platform-statistics'
    import {
        api_account_list,
        ...
        methods: {
            ...
            get_spu(){
                this.$nextTick(()=>{
                    ...
                    this.$http(api_on_spu,data).then(res=>{
