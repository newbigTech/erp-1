<template>
    <div>
        <el-table :data="tableData"
            ...
            <el-table-column label="订单数" inline-template width="70">
                <div>
            ...
            <el-table-column key="channel_cost" label="平台费用CNY" width="100" inline-template>
                <div>
                    <ui-tip :content="row.channel_cost | toFixed2" :width="98"></ui-tip>
                </div>
            </el-table-column>
            <el-table-column key="paypal_fee" label="PayPal费用" inline-template>
                <div>
                    <ui-tip :content="row.paypal_fee | toFixed2" :width="98"></ui-tip>
                </div>
            </el-table-column>
            <el-table-column label="货币转换费" inline-template width="100">
                <div>
                    <ui-tip :content="row.currency_transform_fee | toFixed2" :width="98"></ui-tip>
                </div>
            </el-table-column>
            ...
            <el-table-column label="毛利" inline-template width="70">
                <div>
                    <ui-tip :content="row.gross_profit | toFixed2" :width="98"></ui-tip>
                </div>
            </el-table-column>
            <el-table-column label="退款" inline-template width="70">
                <div>
                    <ui-tip :content="row.refund_amount | toFixed2" :width="98"></ui-tip>
                </div>
            </el-table-column>
            <el-table-column key="shop_fee" label="店铺费用" inline-template>
                <div>
            ...
            <el-table-column label="利润率" inline-template width="70">
                <div>
                    <ui-tip :content="row.profit_rate" :width="98"></ui-tip>
                </div>
            </el-table-column>
            <el-table-column label="补贴后利润" inline-template>
                <div>
                    <ui-tip :content="row.after_subsidy_profits | toFixed2" :width="98"></ui-tip>
                </div>
            </el-table-column>
            <el-table-column label="补贴后利润率" inline-template width="100">
                <div>
                    <ui-tip :content="row.after_subsidy_profits_rate | toFixed2" :width="98"></ui-tip>
                </div>
            </el-table-column>
        </el-table>
        <el-pagination
...
<script>
    import {api_ebay_list, api_export_performance} from '@/api/selling-profit';
