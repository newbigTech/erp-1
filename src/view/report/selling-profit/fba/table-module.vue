<template>
    <div>
        <el-table :data="tableData"
            ...
            <el-table-column label="销售组长" inline-template>
                <div>
                    <ui-tip :content="row.sale_group_leader" :width="98"></ui-tip>
                </div>
            </el-table-column>
            <el-table-column label="销售主管" inline-template>
                <div>
            ...
            <el-table-column label="店铺费用" inline-template>
                <div>
                    <ui-tip :content="row.shop_fee | toFixed2" :width="98"></ui-tip>
                </div>
            </el-table-column>
            <el-table-column label="利润" inline-template>
                <div>
...
<script>
    import {api_fba_list, api_export_performance} from '../../../../api/selling-profit';
    export default {
        data(){
            return {
                tableData:[],
        ...
        methods: {
            init(){
                ...
                this.$http(api_fba_list, data).then(res=>{
                    this.loading = false;
